...
{/* Dropdown */}
      ...
      {/* <Header /> */}
            ...
            <br/>
            <br/>
            <h1>Our School Visit Programs</h1>
            ...
            <section className="gallery section" id='internship'>
               <div className="gallery__container container grid">
                  ...
                  <div className="gallery__image">
                     <img src={school1_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(school1_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={school2_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(school2_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={school3_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(school3_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={school4_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(school4_Img)}/>
                  </div>
               </div>
            </section>
