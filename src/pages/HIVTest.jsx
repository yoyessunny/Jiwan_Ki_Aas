...
import hiv1_Img from '../assets/HIV1.jpg'
import hiv2_Img from '../assets/HIV2.jpg'
import hiv3_Img from '../assets/HIV3.jpg'
import hiv4_Img from '../assets/HIV4.jpg'
import '../App.css'
import "swiper/css";
...
{/* Dropdown */}
      ...
      {/* <Header /> */}
            ...
            <br/>
            <br/>
            <h1>Our HIV Testing and Monitoring Programs</h1>
            ...
            <section className="gallery section" id='internship'>
               <div className="gallery__container container grid">
                  ...
                  <div className="gallery__image">
                     <img src={hiv1_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(hiv1_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={hiv2_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(hiv2_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={hiv3_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(hiv3_Img)}/>
                  </div>
      
                  <div className="gallery__image">
                     <img src={hiv4_Img} alt="image" className="gallery__img" onClick={() => setSelectedImage(hiv4_Img)}/>
                  </div>
               </div>
            </section>
